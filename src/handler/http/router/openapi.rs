...
#[openapi(
    paths(
        ...
        request::dashboards::add_panel,
        request::dashboards::update_panel,
        request::dashboards::delete_panel,
        ...
        request::dashboards::reports::create_report_v2,
        request::dashboards::reports::list_reports_v2,
        request::dashboards::reports::get_report_v2,
        request::dashboards::reports::update_report_v2,
        ...
        request::authz::fga::get_roles_for_all_users,
    ...
    components(
        schemas(
            ...
            request::alerts::incidents::UpdatePayload,
            request::alerts::incidents::IncidentSeverity,
            request::alerts::incidents::IncidentStatus,
            ...
            config::meta::synthetics::StatusBucket,
            config::meta::synthetics::BucketStatus,
         ),
    ),
